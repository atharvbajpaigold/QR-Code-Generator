...
def generateCode():
  ...
  messagebox.showinfo(title="Just a good news for you :)",message="your QR Code Has Been Successfully Saved In :"+fileDirec)
headingFrame = Frame(wn,bg="azure",bd=5)
headingFrame.place(relx=0.15,rely=0.05,relwidth=0.7,relheight=0.1)
headingLabel = Label(headingFrame, text="QR Code Generator", bg='sky blue', font=('Times',20,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)
Frame1 = Frame(wn,bg="black")
Frame1.place(relx=0.1,rely=0.15,relwidth=0.7,relheight=0.3)
label1 = Label(Frame1,text="Enter the URL: ",bg="black",fg='azure',font=('Courier',13,'bold'))
...
label3 = Label(Frame3,text="Enter the title of the QR Code: ",bg="black",fg='azure',font=('Courier',13,'bold'))
...
button = Button(wn, text='Generate Your QR Code',font=('Courier',15,'normal'),command=generateCode,fg="Navy BLue")
